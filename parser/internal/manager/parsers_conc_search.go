...
func (pm *ParsersManager) concurrentSearchWithTimeout2(ctx context.Context, params models.SearchParams, parsers []string) ([]models.SearchResult, error) {
...
func (pm *ParsersManager) getAliveParsers(names []string) []interfaces.Parser {
	var result []interfaces.Parser
